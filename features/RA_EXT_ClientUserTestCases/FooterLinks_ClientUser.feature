@FooterLinks @FooterLinks_ClientUser
Feature: Footer Links for Client User
  ...
  @readOnly
  Scenario Outline: TC001_02_ClientUser_FooterLinks - Verify footer page content
  ...
  @readOnly
  Scenario: TC001_03_ClientUser_FooterLinks - Verify Cookie Settings popup
    When press "Cookie Settings" button
    Then the "Privacy Preference Center" popup is displayed

  @readOnly
  Scenario: TC001_04_ClientUser_FooterLinks - Verify Disclaimer page legal content
