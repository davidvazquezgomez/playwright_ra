@DashboardUpdate @DashboardUpdate_ClientUser
Feature: Dashboard Updates for Client User
  ...
  @readOnly
  Scenario: TC001_01_ClientUser_DashboardUpdates - Navigate to dashboard updates page
    ...
    And verify "All Updates" tabs are displayed in "ClientPortal_20260209133616 - Updates Dashboard" page
    ...
    Then verify pagination is displayed in the "ClientPortal_20260209133616 - Updates Dashboard" page

  @readOnly
  Scenario Outline: TC001_02_ClientUser_DashboardUpdates - Sort column headers and verify the sorting functionality
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    Then verify "<column>" column header is displayed in the "ClientPortal_20260209133616 - Updates Dashboard" page
    When click on "<column>" column header in the "ClientPortal_20260209133616 - Updates Dashboard" page
    Then verify items are sorted in "ascending" order by "<column>" in the "ClientPortal_20260209133616 - Updates Dashboard" page
    When click on "<column>" column header in the "ClientPortal_20260209133616 - Updates Dashboard" page
    Then verify items are sorted in "descending" order by "<column>" in the "ClientPortal_20260209133616 - Updates Dashboard" page
    When click on "<column>" column header in the "ClientPortal_20260209133616 - Updates Dashboard" page
    Then verify sorting is removed for "<column>" in the "ClientPortal_20260209133616 - Updates Dashboard" page
  ...
  @mutable
  Scenario: TC002_01_ClientUser_DashboardUpdates - Verify read/unread functionality on the "Unread Updates" tab
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
  ...
  Scenario Outline: TC003_06_ClientUser_DashboardUpdates - Upload an attachment with unsupported format
    ...
    And click on "Upload files" option from the "ClientPortal_20260209133616 - Updates Dashboard" page
  ...
  @readOnly
  Scenario: TC004_ClientUser_DashboardUpdates - Verify search
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
  ...
  @readOnly
  Scenario: TC006_01_ClientUser_DashboardUpdates - Reset the filter
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    Then save the "ClientPortal_20260209133616 - Updates Dashboard" items
  ...
  @readOnly
  Scenario: TC006_02_ClientUser_DashboardUpdates - Apply a predefined filter
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    ...
    And select "28 Nov 2025" in the "Start date" filter on the Dashboard filter
  ...
  Scenario: TC006_03_ClientUser_DashboardUpdates - Create, save and delete a custom filter
    ...
    And press "Save filter" button on the Dashboard filter
    Then verify "Filter saved successfully." toast message is displayed in the "ClientPortal_20260209133616 - Updates Dashboard" page
    When press "Filter" button on the Dashboard filter
    ...
    Then verify "Saved filter deleted successfully." toast message is displayed in the "ClientPortal_20260209133616 - Updates Dashboard" page

  @readOnly
  Scenario: TC006_04_ClientUser_DashboardUpdates - Apply a customized filter
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    And save the "ClientPortal_20260209133616 - Updates Dashboard" items
    When press "Filter" button on the Dashboard filter
    Then select "Test_ClientUser" located in the "Saved Filters" section on the Dashboard filter
    And press "View results" button on the Dashboard filter
    Then verify the "ClientPortal_20260209133616 - Updates Dashboard" item count is not the same

  @mutable
  Scenario: TC006_05_ClientUser_DashboardUpdates - Mark and unmark a filter as favourite
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    And save the "ClientPortal_20260209133616 - Updates Dashboard" items
    When press "Filter" button on the Dashboard filter
  ...
  @readOnly
  Scenario: TC006_06_ClientUser_DashboardUpdates - Clear all filters
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    When press "Filter" button on the Dashboard filter
  ...
  @readOnly
  Scenario: TC007_01_ClientUser_DashboardUpdates - Apply two filters
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    And save the "ClientPortal_20260209133616 - Updates Dashboard" items
  ...
  @readOnly
  Scenario: TC007_02_ClientUser_DashboardUpdates - Verify actions dashboard select all filter after applying two filters
    Given the "ClientPortal_20260209133616 - Updates Dashboard - All Updates" page is open
    When press "Filter" button on the Dashboard filter
