@Overview @Overview_DeloitteUser
Feature: Overview for Deloitte User
  ...
  @readOnly
  Scenario Outline: TC002_DeloitteUser_Overview - Verify navigation from overview widgets
    When click on "01_13Jan REG" of the portals
    Then the "Overview" page is displayed
  ...
  @readOnly
  Scenario: TC004_DeloitteUser_Overview - Verify View as Grid and Card functionality and Save as Favorite option
    When click on "01_13Jan REG" of the portals
    Then the "Overview" page is displayed
