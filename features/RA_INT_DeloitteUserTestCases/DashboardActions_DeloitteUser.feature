@ActionsDashboard @ActionsDashboard_DeloitteUser
Feature: Dashboard Actions for Deloitte User
  ...
  @readOnly
  Scenario: TC009_01_DeloitteUser_DashboardActions - Verify dashboard actions tab
    When click on "QA_Test client3" of the portals
    Then the "Overview" page is displayed
    And verify for client portal name "QA_Test client3 - Overview"
    When press "Open Dashboard" button
    Then the "QA_Test client3 - Updates Dashboard" page is displayed
    And verify "Updates;Actions;Analytics" tabs are displayed in "QA_Test client3 - Updates Dashboard" page
    When press "Actions" button
    Then the "QA_Test client3 - Actions Dashboard" page is displayed
    And verify "All Actions" tabs are displayed in "QA_Test client3 - Actions Dashboard" page
    When press "My Actions" button
    Then verify pagination is displayed in the "QA_Test client3 - Actions Dashboard" page
  ...
  Scenario Outline: TC009_02_DeloitteUser_DashboardActions - Verify default column header and sorting
    ...
    When click on "<column>" column header in the "QA_Test client3 - Actions Dashboard" page
    Then verify items are sorted in "descending" order by "<column>" in the "QA_Test client3 - Actions Dashboard" page
    When click on "<column>" column header in the "QA_Test client3 - Actions Dashboard" page
    Then verify sorting is removed for "<column>" in the "QA_Test client3 - Actions Dashboard" page
  ...
  Scenario: TC010_01_DeloitteUser_DashboardActions - Create new action from the actions dashboard
    ...
    When fill the "Update" field with "04May 2026 Employment Income Brackets test stage" value in the "Add Action" popup
    And fill the "Action" field with "Test Action" value in the "Add Action" popup
    And select "test, TesNonDeloitteUser" options in the "User Assigned" field in the "Add Action" popup
    ...
    Then verify "04May 2026 Employment Income Brackets test stage" value is displayed in the "Update" field on the "Add Action" popup
    And verify "Test Action" value is displayed in the "Action" field on the "Add Action" popup
    And verify "test, TesNonDeloitteUser" options are selected in the "User Assigned" field on the "Add Action" popup
    ...
    When press "Save" button
    Then verify "Action added successfully" toast message is displayed in the "QA_Test client3 - Actions Dashboard" page
    ...
    And click on "Deadline Date" column header in the "QA_Test client3 - Actions Dashboard" page
    And click on "Deadline Date" column header in the "QA_Test client3 - Actions Dashboard" page
    Then verify "Test Action" action is displayed in the first row of the "QA_Test client3 - Actions Dashboard" page
  ...
  Scenario: TC010_02_DeloitteUser_DashboardActions - Verify editing an action
    ...
    Then verify "Increase to Monthly Social Security Tax Bases" update is displayed in the "QA_Test client3 - Actions Dashboard" page
  ...
  Scenario: TC011_01_DeloitteUser_DashboardActions - Verify adding an action from the update details page
    ...
    Then verify "Increase to Monthly Social Security Tax Bases" update is displayed from the "Updates Dashboard - QA_Test client3" page
    When open the first update in the "Updates Dashboard - QA_Test client3" page
    ...
    And verify comments section is not displayed in the "Add Action" popup
    And verify attachments section is not displayed in the "Add Action" popup
    And verify "Increase to Monthly Social Security Tax Bases" value is displayed in the "Update" field on the "Add Action" popup
    When press "Save" button
  ...
  Scenario: TC012_02_DeloitteUser_DashboardActions - Verify filtering the actions dashboard by deadline range
    ...
    And select "05/08/2026" from the "End Date" calendar on the Dashboard filter
    And press "View results" button on the Dashboard filter
