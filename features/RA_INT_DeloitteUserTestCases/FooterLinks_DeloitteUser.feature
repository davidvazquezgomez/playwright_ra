@FooterLinks @FooterLinks_DeloitteUser
Feature: Footer Links for Deloitte User
  ...
  @readOnly
  Scenario Outline: TC001_02_DeloitteUser_FooterLinks - Verify footer page content
  ...
  @readOnly
  Scenario: TC001_03_DeloitteUser_FooterLinks - Verify Cookie Settings popup
    When press "Cookie Settings" button
    Then the "Privacy Preference Center" popup is displayed

  @readOnly
  Scenario: TC001_04_DeloitteUser_FooterLinks - Verify Disclaimer page legal content
