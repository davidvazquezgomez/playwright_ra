...
Feature: Dashboard Analytics for Deloitte User
  ...
  @readOnly
  Scenario: TC014_08_DeloitteUser_DashboardAnalytics - Verify Outstanding Updates Map controls
  ...
  @readOnly
  Scenario: TC016_03_DeloitteUser_DashboardAnalytics - Apply a predefined filter Action Analytics page
    Given the "QA_Test client3 - Analytics Dashboard - Action Analytics" page is open
    Then save the value from the "Outstanding Actions" chart
    And save the value from the "Action Priority" chart
    And save the value from the "Completed Actions" chart
  ...
  @readOnly
  Scenario: TC016_10_DeloitteUser_DashboardAnalytics - Verify Completed Actions chart is updated after filtering
    Given the "QA_Test client3 - Analytics Dashboard - Action Analytics" page is open
  ...
  Scenario Outline: TC017_05_DeloitteUser_DashboardAnalytics - Verify sort order is retained after navigating away
    Given the "QA_Test client3 - Analytics Dashboard - Action Analytics" page is open
    Then verify the "Actions Analytics Data" chart is displayed
    Then verify "<column>" column header is displayed in the "QA_Test client3 - Analytics Dashboard - Action Analytics" page
    When click on "<column>" column header in the "QA_Test client3 - Analytics Dashboard - Action Analytics" page
    Then verify items are sorted in "ascending" order by "<column>" in the "" page
    When click on "<column>" column header in the "QA_Test client3 - Analytics Dashboard - Action Analytics" page
  ...
  @readOnly
  Scenario: TC017_06_DeloitteUser_DashboardAnalytics - Verify Action Analytics Data table pagination and update details navigation
    Given the "QA_Test client3 - Analytics Dashboard - Action Analytics" page is open
    Then verify the "Actions Analytics Data" chart is displayed
