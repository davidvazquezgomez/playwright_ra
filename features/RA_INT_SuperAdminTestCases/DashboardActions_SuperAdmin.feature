@ActionsDashboard @ActionsDashboard_SuperAdmin
Feature: Dashboard Actions for Super Admin
  ...
  @readOnly
  Scenario: TC009_01_SuperAdmin_DashboardActions - Verify dashboard actions tab
    ...
    And verify "All Actions" tabs are displayed in "01_13Jan REG - Actions Dashboard" page
    When press "My Actions" button
    Then verify pagination is displayed in the "01_13Jan REG - Actions Dashboard" page
  ...
  Scenario Outline: TC009_02_SuperAdmin_DashboardActions - Verify default column header and sorting
    ...
    When click on "<column>" column header in the "01_13Jan REG - Actions Dashboard" page
    Then verify items are sorted in "descending" order by "<column>" in the "01_13Jan REG - Actions Dashboard" page
    When click on "<column>" column header in the "01_13Jan REG - Actions Dashboard" page
    Then verify sorting is removed for "<column>" in the "01_13Jan REG - Actions Dashboard" page
  ...
  Scenario: TC010_01_SuperAdmin_DashboardActions - Create new action from the actions dashboard
    ...
    And click on "Deadline Date" column header in the "01_13Jan REG - Actions Dashboard" page
    Then verify "Test Action" action is displayed in the first row of the "01_13Jan REG - Actions Dashboard" page
  ...
  @mutable
  Scenario: TC011_02_SuperAdmin_DashboardActions - Verify editing an action from the update details page
    Given the "Updates Dashboard - 01_13Jan REG" page is open
    When search for "Occupational Illness Trust Fund" update from the "Updates Dashboard - 01_13Jan REG" page
  ...
  @mutable
  Scenario: TC011_03_SuperAdmin_DashboardActions - Verify the private action toggle from the update details page
    Given the "Updates Dashboard - 01_13Jan REG" page is open
    When search for "Occupational Illness Trust Fund" update from the "Updates Dashboard - 01_13Jan REG" page
    And open the first update in the "Updates Dashboard - 01_13Jan REG" page
    And open the "Update Actions" tab on the selected update
  ...
  @mutable
  Scenario: TC011_04_SuperAdmin_DashboardActions - Verify adding a comment to an action from the update details page
    Given the "Updates Dashboard - 01_13Jan REG" page is open
    When search for "Occupational Illness Trust Fund" update from the "Updates Dashboard - 01_13Jan REG" page
    And open the first update in the "Updates Dashboard - 01_13Jan REG" page
    And open the "Update Actions" tab on the selected update
  ...
  @mutable
  Scenario Outline: TC011_05_SuperAdmin_DashboardActions - Verify uploading an attachment to an action from the update details page
    Given the "Updates Dashboard - 01_13Jan REG" page is open
    When search for "Occupational Illness Trust Fund" update from the "Updates Dashboard - 01_13Jan REG" page
    And open the first update in the "Updates Dashboard - 01_13Jan REG" page
    And open the "Update Actions" tab on the selected update
