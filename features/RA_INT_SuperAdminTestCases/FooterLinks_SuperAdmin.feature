@FooterLinks @FooterLinks_SuperAdmin
Feature: Footer Links for Super Admin
  ...
  @readOnly
  Scenario Outline: TC001_02_SuperAdmin_FooterLinks - Verify footer page content
  ...
  @readOnly
  Scenario: TC001_03_SuperAdmin_FooterLinks - Verify Cookie Settings popup
    When press "Cookie Settings" button
    Then the "Privacy Preference Center" popup is displayed

  @readOnly
  Scenario: TC001_04_SuperAdmin_FooterLinks - Verify Disclaimer page legal content
