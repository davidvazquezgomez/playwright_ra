...
Feature: Automatic Allocation of Updates for Super Admin
  ...
  Scenario: TC001_04_SuperAdmin_AutomaticAllocation - Create and delete an allocation with the Cancel button
    ...
    And select the "satestclientuser4, satestclientuser4" option in the "Update Owner" field
    ...
    And verify "satestclientuser4, satestclientuser4" is still selected in the "Update Owner" field
