@FooterLinks @FooterLinks_PortalAdmin
Feature: Footer Links for Portal Admin
  ...
  @readOnly
  Scenario Outline: TC001_02_PortalAdmin_FooterLinks - Verify footer page content
  ...
  @readOnly
  Scenario: TC001_03_PortalAdmin_FooterLinks - Verify Cookie Settings popup
    When press "Cookie Settings" button
    Then the "Privacy Preference Center" popup is displayed

  @readOnly
  Scenario: TC001_04_PortalAdmin_FooterLinks - Verify Disclaimer page legal content
