...
Feature: Dashboard Updates for Portal Admin
  ...
  @readOnly
  Scenario: TC001_01_PortalAdmin_DashboardUpdates - Navigate to dashboard updates page
    ...
    And verify "All Updates" tabs are displayed in "Global Inc - Updates Dashboard" page
    And verify "Updates;Actions;Analytics" tabs are displayed in "Global Inc - Updates Dashboard" page
    When press the "Unread Updates" subsection
    Then verify pagination is displayed in the "Global Inc - Updates Dashboard" page

  @readOnly
  Scenario Outline: TC001_02_PortalAdmin_DashboardUpdates - Sort column headers and verify the sorting functionality
    Given the "Global Inc - Updates Dashboard - All Updates" page is open
    Then verify "<column>" column header is displayed in the "Global Inc - Updates Dashboard" page
    When click on "<column>" column header in the "Global Inc - Updates Dashboard" page
    Then verify items are sorted in "ascending" order by "<column>" in the "Global Inc - Updates Dashboard" page
    When click on "<column>" column header in the "Global Inc - Updates Dashboard" page
    Then verify items are sorted in "descending" order by "<column>" in the "Global Inc - Updates Dashboard" page
    When click on "<column>" column header in the "Global Inc - Updates Dashboard" page
    Then verify sorting is removed for "<column>" in the "Global Inc - Updates Dashboard" page
  ...
  Scenario: TC003_01_PortalAdmin_DashboardUpdates - Create and revert a modification of an update
    ...
    Then enter "User5, External" in the "User Assigned" field
    And select "User5, External" from the search results
    ...
    And enter "Ben Chris" in the "Watch List" field
    And select "Ben Chris" from the search results
  ...
  #Rectifico para restaurar los datos 
    ...
    When press "Edit" button on the selected update
    Then enter "Emea, Celina" in the "User Assigned" field
    And select "Emea, Celina" from the search results
  ...
  Scenario: TC006_01_PortalAdmin_DashboardUpdates - Reset the filter
    ...
    Then verify the "Global Inc - Updates Dashboard" item count is the same

  @readOnly
  Scenario: TC006_02_PortalAdmin_DashboardUpdates - Apply a predefined filter
    Given the "Global Inc - Updates Dashboard - All Updates" page is open
    Then save the "Global Inc - Updates Dashboard" items
    When press "Filter" button on the Dashboard filter
    Then verify the "Saved Filters;My Updates;Knowledge Module;Jurisdiction;Impact Areas;Priority;Status" option is displayed in the Dashboard filter
  ...
  @readOnly
  Scenario: TC006_04_PortalAdmin_DashboardUpdates - Apply a customized filter
    Given the "Global Inc - Updates Dashboard - All Updates" page is open
    Then save the "Global Inc - Updates Dashboard" items
    When press "Filter" button on the Dashboard filter
  ...
  @mutable
  Scenario: TC006_05_PortalAdmin_DashboardUpdates - Mark and unmark a filter as favourite
    Given the "Global Inc - Updates Dashboard - All Updates" page is open
    Then save the "Global Inc - Updates Dashboard" items
    When press "Filter" button on the Dashboard filter
    ...
    Then verify the "Global Inc - Updates Dashboard" item count is not the same
    When press "Remove as favourite" button for "SelectAll_Test_1784117406226" on the Dashboard filter
  ...
  @readOnly
  Scenario: TC007_02_PortalAdmin_DashboardUpdates - Verify actions dashboard select all filter after applying two filters
    Given the "Global Inc - Updates Dashboard - All Updates" page is open
    When press "Filter" button on the Dashboard filter
  ...
  Scenario: TC008_PortalAdmin_DashboardUpdates - Verify updates dashboard dashboard options
    ...
    And verify "Status" column header is not displayed in the "Global Inc - Updates Dashboard" page
    And logout from the application
