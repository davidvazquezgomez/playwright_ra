@Overview @Overview_PortalAdmin
Feature: Overview for Portal Admin
...
@readOnly
Scenario: TC001_PortalAdmin_Overview - Verify overview page loads with all the fields and buttons visible
  ...
  @readOnly
  Scenario Outline: TC002_PortalAdmin_Overview - Verify navigation from overview widgets
    When click on "Global Inc" of the portals
    Then the "Overview" page is displayed
    ...
    Examples:
      ...
      | Outstanding Updates;Outstanding Actions | Outstanding Updates | View All Updates | Global Inc - Updates Dashboard | Updates;Actions;Analytics |
      | Outstanding Updates;Outstanding Actions | Outstanding Actions | View All Actions | Global Inc - Actions Dashboard | Updates;Actions;Analytics |

  @readOnly
  Scenario Outline: TC003_02_PortalAdmin_Overview - Verify left navigation options
    When click on "Global Inc" of the portals
    Then the "Overview" page is displayed
    When click on "<item>" option from the left navigation
    ...
    Examples:
      ...
      | Automatic Allocation of Updates | Automatic Allocation of Updates |

  @readOnly
  Scenario: TC004_PortalAdmin_Overview - Verify View as Grid and Card functionality and Save as Favorite option
    When click on "Global Inc" of the portals
    Then the "Overview" page is displayed
...
@readOnly
Scenario: TC005_PortalAdmin_Overview - Verify navigation from Open Dashboard to Updates Dashboard and vice versa
    When click on "Global Inc" of the portals
    Then the "Overview" page is displayed
