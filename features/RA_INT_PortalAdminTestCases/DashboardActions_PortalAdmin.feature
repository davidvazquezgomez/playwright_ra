...
Feature: Dashboard Actions for Portal Admin
  ...
  @readOnly
  Scenario: TC009_01_PortalAdmin_DashboardActions - Verify dashboard actions tab
    When click on "Global Inc" of the portals
    Then the "Overview" page is displayed
    And verify for client portal name "Global Inc - Overview"
  ...
  Scenario Outline: TC009_02_PortalAdmin_DashboardActions - Verify default column header and sorting
    ...
    Then verify items are sorted in "ascending" order by "<column>" in the "Global Inc - Actions Dashboard" page
    When click on "<column>" column header in the "Global Inc - Actions Dashboard" page
    Then verify items are sorted in "descending" order by "<column>" in the "Global Inc - Actions Dashboard" page
    When click on "<column>" column header in the "Global Inc - Actions Dashboard" page
    Then verify sorting is removed for "<column>" in the "Global Inc - Actions Dashboard" page
  ...
  Scenario: TC010_01_PortalAdmin_DashboardActions - Create new action from the actions dashboard
    ...
    When fill the "Update" field with "04May 2026 Employment Income Brackets test stage sp multiple" value in the "Add Action" popup
    And fill the "Action" field with "Test Action" value in the "Add Action" popup
    And select "Rewspec, Gwyn" options in the "User Assigned" field in the "Add Action" popup
    ...
    Then verify "04May 2026 Employment Income Brackets test stage sp multiple" value is displayed in the "Update" field on the "Add Action" popup
    And verify "Test Action" value is displayed in the "Action" field on the "Add Action" popup
    And verify "Rewspec, Gwyn" options are selected in the "User Assigned" field on the "Add Action" popup
    ...
    When press "Save" button
    Then verify "Action added successfully" toast message is displayed in the "Global Inc - Actions Dashboard" page
  ...
  @mutable
  Scenario: TC010_05_PortalAdmin_DashboardActions - Verify uploading an attachment to an action
    Given the "Global Inc - Actions Dashboard" page is open
    When press "Filter" button on the Dashboard filter
    And press "Reset Filters" button on the Dashboard filter
    And double-click "SelectAll_Test_1784288008539" option on the Dashboard filter
  ...
  Scenario: TC011_01_PortalAdmin_DashboardActions - Verify adding an action from the update details page
    ...
    Then verify "Occupational Illness Trust Fund" update is displayed from the "Updates Dashboard - Global Inc" page
    When open the first update in the "Updates Dashboard - Global Inc" page
  ...
  Scenario: TC012_02_PortalAdmin_DashboardActions - Verify filtering the actions dashboard by deadline range
    ...
    When select "05/10/2025" from the "Start Date" calendar on the Dashboard filter
    And select "07/10/2025" from the "End Date" calendar on the Dashboard filter
    And press "View results" button on the Dashboard filter
  ...
  @readOnly
  Scenario: TC012_05_PortalAdmin_DashboardActions - Verify resetting the actions dashboard filters
    Given the "Global Inc - Actions Dashboard" page is open
    When press "Filter" button on the Dashboard filter
    And press "Reset Filters" button on the Dashboard filter
    When select "Low" in the "Action Priority" filter on the Dashboard filter
    ...
    And verify filtered actions are displayed for "Jurisdiction" with value "Argentina"
    When press "Filter" button on the Dashboard filter
    And press "Reset Filters" button on the Dashboard filter
  ...
  @readOnly
  Scenario: TC013_PortalAdmin_DashboardActions - Verify actions dashboard select all filter
    Given the "Global Inc - Actions Dashboard" page is open
    When press "Filter" button on the Dashboard filter
