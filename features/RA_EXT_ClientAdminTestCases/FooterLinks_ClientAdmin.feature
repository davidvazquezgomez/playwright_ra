@FooterLinks @FooterLinks_ClientAdmin
Feature: Footer Links for Client Admin
  ...
  @readOnly
  Scenario Outline: TC001_02_ClientAdmin_FooterLinks - Verify footer page content
  ...
  @readOnly
  Scenario: TC001_03_ClientAdmin_FooterLinks - Verify Cookie Settings popup
    When press "Cookie Settings" button
    Then the "Privacy Preference Center" popup is displayed

  @readOnly
  Scenario: TC001_04_ClientAdmin_FooterLinks - Verify Disclaimer page legal content
