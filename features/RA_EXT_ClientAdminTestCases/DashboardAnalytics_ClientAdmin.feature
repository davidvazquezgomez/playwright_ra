@DashboardAnalytics @DashboardAnalytics_ClientAdmin
Feature: Dashboard Analytics for Client Admin
  ...
  @readOnly
  Scenario: TC014_01_ClientAdmin_DashboardAnalytics - Navigate to Update Analytics page
  ...
  @readOnly
  Scenario: TC014_02_ClientAdmin_DashboardAnalytics - Reset the filter
  ...
  @readOnly
  Scenario: TC014_03_ClientAdmin_DashboardAnalytics - Apply a predefined filter
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable @cleanup
  Scenario: TC014_04_ClientAdmin_DashboardAnalytics - Create, save and delete a custom filter
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @readOnly
  Scenario: TC014_05_ClientAdmin_DashboardAnalytics - Apply a customized filter
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then save the value from the "Outstanding Updates" chart
    And save the value from the "Update Priority" chart
  ...
  @readOnly
  Scenario: TC014_06_ClientAdmin_DashboardAnalytics - Verify Outstanding Updates chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @readOnly
  Scenario: TC014_08_ClientAdmin_DashboardAnalytics - Verify Outstanding Updates Map controls
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable
  Scenario: TC014_09_ClientAdmin_DashboardAnalytics - Verify Update Priority chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @mutable
  Scenario: TC015_01_ClientAdmin_DashboardAnalytics - Verify data consistency between Update Analytics Data and All Updates section
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable
  Scenario: TC015_02_ClientAdmin_DashboardAnalytics - Compare Update Analytics Data and Updates Dashboard pages for a selected result
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable
  Scenario: TC015_03_ClientAdmin_DashboardAnalytics - Verify Update Analytics Data chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then verify the "Update Analytics Data" chart is displayed
    When press "Filter" button on the Dashboard filter
  ...
  @readOnly
  Scenario Outline: TC015_04_ClientAdmin_DashboardAnalytics - Verify sort order is retained after navigating away
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then verify the "Update Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC015_05_ClientAdmin_DashboardAnalytics - Verify Update Analytics Data table pagination and update details navigation
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then verify the "Update Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC016_01_ClientAdmin_DashboardAnalytics - Navigate to Action Analytics page
    When click on "01_QA_StageTestPortal" of the portals
    Then the "01_QA_StageTestPortal - Overview" page is displayed
    When press "Open Dashboard" button
    Then the "01_QA_StageTestPortal - Updates Dashboard" page is displayed
  ...
  @readOnly
  Scenario: TC016_02_ClientAdmin_DashboardAnalytics - Reset the filter Action Analytics page
  ...
  @readOnly
  Scenario: TC016_03_ClientAdmin_DashboardAnalytics - Apply a predefined filter Action Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then save the value from the "Outstanding Actions" chart
    And save the value from the "Action Priority" chart
  ...
  @mutable @cleanup
  Scenario: TC016_04_ClientAdmin_DashboardAnalytics - Create, save and delete a custom filter in the Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    When remove saved filter "QaTest" if it exists on the Dashboard filter
  ...
  @readOnly
  Scenario: TC016_05_ClientAdmin_DashboardAnalytics - Apply a customized filter Action Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then save the value from the "Outstanding Actions" chart
    And save the value from the "Action Priority" chart
  ...
  @readOnly
  Scenario: TC016_06_ClientAdmin_DashboardAnalytics - Verify Outstanding Actions chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @readOnly
  Scenario: TC016_08_ClientAdmin_DashboardAnalytics - Verify Outstanding Actions Map controls
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
  ...
  @mutable
  Scenario: TC016_09_ClientAdmin_DashboardAnalytics - Verify Action Priority chart is updated after filtering on the Action Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @readOnly
  Scenario: TC016_10_ClientAdmin_DashboardAnalytics - Verify Completed Actions chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @mutable
  Scenario: TC017_01_ClientAdmin_DashboardAnalytics - Verify Data consistency between Actions Analytics Data and All Actions section
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
  ...
  @mutable
  Scenario: TC017_02_ClientAdmin_DashboardAnalytics - Compare Action Analytics Data and Actions Dashboard pages for a selected result
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    When search for "21Declarations have been clarified for 2026" update in the Analytics Dashboard
    Then verify the "Actions Analytics Data" chart is displayed
    When select the "21Declarations have been clarified for 2026" result by clicking on the "Action" section
  ...
  @mutable
  Scenario: TC017_03_ClientAdmin_DashboardAnalytics - Verify the information displayed when selecting an Action result
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    When search for "21Declarations have been clarified for 2026" update in the Analytics Dashboard
    Then verify the "Actions Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC017_04_ClientAdmin_DashboardAnalytics - Verify Action Analytics Data chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then verify the "Actions Analytics Data" chart is displayed
    When press "Filter" button on the Dashboard filter
  ...
  @readOnly
  Scenario Outline: TC017_05_ClientAdmin_DashboardAnalytics - Verify sort order is retained after navigating away
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then verify the "Actions Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC017_06_ClientAdmin_DashboardAnalytics - Verify Action Analytics Data table pagination and update details navigation
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then verify the "Actions Analytics Data" chart is displayed
