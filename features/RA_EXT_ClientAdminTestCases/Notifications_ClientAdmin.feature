@Notifications @Notifications_ClientAdmin
Feature: Notifications for Client Admin
  ...
  @mutable
  Scenario: TC001_ClientAdmin_Notifications - Verify that when you access notification preferences by clicking the Edit button, the available frequency sections are displayed
  ...
  @readOnly
  Scenario: TC001_2_ClientAdmin_Notifications - Verify Notifications Preferences has Actions and Teams Sections Available
  ...
  @mutable
  Scenario: TC001_3_ClientAdmin_Notifications - Verify Notifications Preferences for Updates, Actions and Teams
    Given the "Notifications Preference" page is open
  ...
  @mutable
  Scenario: TC002_1_ClientAdmin_Notifications - Verify Notifications Preferences at user level
    Given the "Notifications Preference" page is open
  ...
  @mutable
  Scenario: TC002_2_ClientAdmin_Notifications - Verify disable Notifications Preferences at user level
    Given the "Notifications Preference" page is open
  ...
  @mutable
  Scenario: TC003_1_ClientAdmin_Notifications - Verify enable Notifications Preferences for updates
  ...
  @mutable
  Scenario: TC003_3_ClientAdmin_Notifications - Verify disabled Notifications Preferences for Updates
    When press "Edit Client" button for the "01_QA_StageTestPortal " client portal
    Then the "Client Portal Setup" page is displayed
    When press "Save & Continue" button on the "Client Portal Setup" page
    Then the "Knowledge Modules & Impact Areas" page is displayed
  ...
  @mutable
  Scenario: TC004_1_ClientAdmin_Notifications - Verify enable Notifications Preferences for actions
    When press "Edit Client" button for the "01_QA_StageTestPortal" client portal
    When press "Save & Continue" button on the "Client Portal Setup" page
    Then the "Knowledge Modules & Impact Areas" page is displayed
    When press "Save & Continue" button on the "Knowledge Modules & Impact Areas" page
  ...
  @mutable
  Scenario: TC004_3_ClientAdmin_Notifications - Verify disabled Notifications Preferences for Actions
    When press "Edit Client" button for the "01_QA_StageTestPortal " client portal
    Then the "Client Portal Setup" page is displayed
    When press "Save & Continue" button on the "Client Portal Setup" page
    Then the "Knowledge Modules & Impact Areas" page is displayed
  ...
  @mutable
  Scenario: TC005_1_ClientAdmin_Notifications - Verify enable Notifications Preferences for teams
    When press "Edit Client" button for the "01_QA_StageTestPortal" client portal
    When press "Save & Continue" button on the "Client Portal Setup" page
    Then the "Knowledge Modules & Impact Areas" page is displayed
    When press "Save & Continue" button on the "Knowledge Modules & Impact Areas" page
  ...
  @mutable
  Scenario: TC005_3_ClientAdmin_Notifications - Verify disabled Notifications Preferences for Teams
    When press "Edit Client" button for the "01_QA_StageTestPortal " client portal
    Then the "Client Portal Setup" page is displayed
    When press "Save & Continue" button on the "Client Portal Setup" page
    Then the "Knowledge Modules & Impact Areas" page is displayed
