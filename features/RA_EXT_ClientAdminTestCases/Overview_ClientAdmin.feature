@Overview @Overview_ClientAdmin
Feature: Overview for Client Admin
  ...
  @readOnly
  Scenario Outline: TC002_ClientAdmin_Overview - Verify navigation from overview widgets
    When click on "01_QA_StageTestPortal" of the portals
    Then the "Overview" page is displayed
  ...
  @readOnly
  Scenario Outline: TC003_02_ClientAdmin_Overview - Verify left navigation options
    When click on "01_QA_StageTestPortal" of the portals
    Then the "Overview" page is displayed
  ...
  @readOnly
  Scenario: TC004_ClientAdmin_Overview - Verify View as Grid and Card functionality and Save as Favorite option
    When click on "01_QA_StageTestPortal" of the portals
    Then the "Overview" page is displayed
