@FooterLinks @FooterLinks_TeamLeader
Feature: Footer Links for Team Leader
  ...
  @readOnly
  Scenario Outline: TC001_02_TeamLeader_FooterLinks - Verify footer page content
  ...
  @readOnly
  Scenario: TC001_03_TeamLeader_FooterLinks - Verify Cookie Settings popup
    When press "Cookie Settings" button
    Then the "Privacy Preference Center" popup is displayed

  @readOnly
  Scenario: TC001_04_TeamLeader_FooterLinks - Verify Disclaimer page legal content
