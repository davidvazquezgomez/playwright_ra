@DashboardAnalytics @DashboardAnalytics_TeamLeader
Feature: Dashboard Analytics for Team Leader
  ...
  @readOnly
  Scenario: TC014_01_TeamLeader_DashboardAnalytics - Navigate to Update Analytics page
  ...
  @readOnly
  Scenario: TC014_02_TeamLeader_DashboardAnalytics - Reset the filter
  ...
  @readOnly
  Scenario: TC014_03_TeamLeader_DashboardAnalytics - Apply a predefined filter
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable @cleanup
  Scenario: TC014_04_TeamLeader_DashboardAnalytics - Create, save and delete a custom filter
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @readOnly
  Scenario: TC014_05_TeamLeader_DashboardAnalytics - Apply a customized filter
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then save the value from the "Outstanding Updates" chart
    And save the value from the "Update Priority" chart
    When press "Filter" button on the Dashboard filter
    When select "Test_FilterTeamLeader2" located in the "Saved Filters" section on the Dashboard filter
    And press "View results" button on the Dashboard filter
    Then verify the "Outstanding Updates" chart value is not the same
    And verify the "Update Priority" chart value is not the same

  @readOnly
  Scenario: TC014_06_TeamLeader_DashboardAnalytics - Verify Outstanding Updates chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @readOnly
  Scenario: TC014_08_TeamLeader_DashboardAnalytics - Verify Outstanding Updates Map controls
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable
  Scenario: TC014_09_TeamLeader_DashboardAnalytics - Verify Update Priority chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @mutable
  Scenario: TC015_01_TeamLeader_DashboardAnalytics - Verify data consistency between Update Analytics Data and All Updates section
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
  ...
  @mutable
  Scenario: TC015_02_TeamLeader_DashboardAnalytics - Compare Update Analytics Data and Updates Dashboard pages for a selected result
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    ...
    And verify the "Update Details" subsection displays the "satestclientuser2, satestclientuser2;High;Update Allocated;;Annual social security rates and wage limits were updated for the 2025 tax year. Employers should review their payroll systems to ensure that the new rates and caps are being properly applied.;1;1;0;2;0;0;Brazil;Employer tax reporting/filing requirements;01 Jul 2028;01 Sep 2028;Tax;Legislative/Binding;Final" values
  ...
  @mutable
  Scenario: TC015_03_TeamLeader_DashboardAnalytics - Verify Update Analytics Data chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then verify the "Update Analytics Data" chart is displayed
    When press "Filter" button on the Dashboard filter
  ...
  @readOnly
  Scenario Outline: TC015_04_TeamLeader_DashboardAnalytics - Verify sort order is retained after navigating away
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then verify the "Update Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC015_05_TeamLeader_DashboardAnalytics - Verify Update Analytics Data table pagination and update details navigation
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Update Analytics" page is open
    Then verify the "Update Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC016_01_TeamLeader_DashboardAnalytics - Navigate to Action Analytics page
    When click on "01_QA_StageTestPortal" of the portals
    Then the "01_QA_StageTestPortal - Overview" page is displayed
    When press "Open Dashboard" button
    Then the "01_QA_StageTestPortal - Updates Dashboard" page is displayed
  ...
  @readOnly
  Scenario: TC016_02_TeamLeader_DashboardAnalytics - Reset the filter Action Analytics page
  ...
  @readOnly
  Scenario: TC016_03_TeamLeader_DashboardAnalytics - Apply a predefined filter Action Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then save the value from the "Outstanding Actions" chart
    And save the value from the "Action Priority" chart
  ...
  @mutable @cleanup
  Scenario: TC016_04_TeamLeader_DashboardAnalytics - Create, save and delete a custom filter in the Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    When remove saved filter "QaTest" if it exists on the Dashboard filter
  ...
  @readOnly
  Scenario: TC016_05_TeamLeader_DashboardAnalytics - Apply a customized filter Action Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then save the value from the "Outstanding Actions" chart
    And save the value from the "Action Priority" chart
  ...
  @readOnly
  Scenario: TC016_06_TeamLeader_DashboardAnalytics - Verify Outstanding Actions chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @readOnly
  Scenario: TC016_08_TeamLeader_DashboardAnalytics - Verify Outstanding Actions Map controls
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
  ...
  @mutable
  Scenario: TC016_09_TeamLeader_DashboardAnalytics - Verify Action Priority chart is updated after filtering on the Action Analytics page
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @readOnly
  Scenario: TC016_10_TeamLeader_DashboardAnalytics - Verify Completed Actions chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
  ...
  @mutable
  Scenario: TC017_01_TeamLeader_DashboardAnalytics - Verify Data consistency between Actions Analytics Data and All Actions section
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
  ...
  @mutable
  Scenario: TC017_02_TeamLeader_DashboardAnalytics - Compare Action Analytics Data and Actions Dashboard pages for a selected result
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    When search for "LINK TEST 1" update in the Analytics Dashboard
    Then verify the "Actions Analytics Data" chart is displayed
    When select the "LINK TEST 1" result by clicking on the "Action" section
    ...
    And verify the "Update Action" modal contains the "LINK TEST 1;test_filter;satestclientuser2, satestclientuser2;Medium;Not Started;21 Aug 2026; Off" values
  ...
  @mutable
  Scenario: TC017_03_TeamLeader_DashboardAnalytics - Verify the information displayed when selecting an Action result
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    When search for "LINK TEST 1" update in the Analytics Dashboard
    Then verify the "Actions Analytics Data" chart is displayed
    When select the "LINK TEST 1" result by clicking on the "Update Title" section
    Then verify the "Update Action" modal is displayed
    And verify the "Update Action" modal contains the "Update;Action;User Assigned; Priority; Status; Deadline;Private Action" sections
    And verify the "Update Action" modal contains the "LINK TEST 1;test_filter;satestclientuser2, satestclientuser2;Medium;Not Started;21 Aug 2026; Off" values
    And verify "Close;Update" buttons are displayed on the "Update Action" popup
  ...
  @readOnly
  Scenario: TC017_04_TeamLeader_DashboardAnalytics - Verify Action Analytics Data chart is updated after filtering
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then press "Clear all filters" section on the Dashboard filter if available
    Then verify the "Actions Analytics Data" chart is displayed
    When press "Filter" button on the Dashboard filter
  ...
  @readOnly
  Scenario Outline: TC017_05_TeamLeader_DashboardAnalytics - Verify sort order is retained after navigating away
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then verify the "Actions Analytics Data" chart is displayed
  ...
  @readOnly
  Scenario: TC017_06_TeamLeader_DashboardAnalytics - Verify Action Analytics Data table pagination and update details navigation
    Given the "01_QA_StageTestPortal - Analytics Dashboard - Action Analytics" page is open
    Then verify the "Actions Analytics Data" chart is displayed
    ...
    Then press the "Analytics" section
    And press the "Actions Analytics" subsection
    And verify that the first result that appears is number "21"
